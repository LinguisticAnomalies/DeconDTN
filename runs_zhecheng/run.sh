...
python3 runs_zhecheng/step101_runExp.py with proj_name="exp_05_06_N100" p_pos_train_z0=[0.5] p_pos_train_z1=[0.6] p_mix_z1=[0.05,0.99,0.05] n_test=[100] n_valid_high=1
...
#python3 runs/step101_runExp.py with proj_name="exp_05_05_N100" p_pos_train_z0=[0.5] p_pos_train_z1=[0.9] p_mix_z1=[0.05,0.99,0.05] n_test=[100] n_valid_high=1

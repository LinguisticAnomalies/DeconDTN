...
df0 = df_shac_uw
df1 = df_shac_mimic
outdir = f"../output/DistilBERT_SHACBalanceAlpha_RandomPermute_ShorterVersion_1_5"
log_f = "../log/DistilBERT_SHACBalanceAlpha_RandomPermute_ShorterVersion_1_5.log"

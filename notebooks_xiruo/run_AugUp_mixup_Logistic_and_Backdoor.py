...
for C, v in [
    ...
    for iRun in range(runs):
        ...
        print(iRun)
        for c in tqdm(valid_full_settings, file=open(f"../log/test_Aug_{args.dataset}_{args.alphaAug}_ConstraintCy_{args.constraintCy}_{args.sample}.txt", "w")):
    ...
    if args.constraintCy:
        ...
        outname = f"{outdir}/UnconstraintCy_mixup_{alphaAug}-AugUP-{transform}-ntest_{n_test}-{penalty}-C{C}-V{v}_{args.sample}.pkl"

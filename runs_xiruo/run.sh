...
python3 runs/step103_runExp_SingleLabel.py with proj_name="exp_SingleHead_05_03" p_pos_train_z0=[0.5] p_pos_train_z1=[0.3] n_test=[150] n_test_error=[5]
python3 runs/step103_runExp_SingleLabel.py with proj_name="exp_SingleHead_05_01" p_pos_train_z0=[0.5] p_pos_train_z1=[0.1] n_test=[150] n_test_error=[15]
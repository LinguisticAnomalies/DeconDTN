...
### TODO
output_dir = f"{args.mntdir}/xiruod/llama2_{args.dataset}/n{args.nTest}/set-{args.CombinationIdx}-{dir_q_snippet}-epoch{globalconfig.num_train_epochs}-llama-2-{args.model_size}B-loraR-{args.lora_r}"
